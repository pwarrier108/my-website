...
In that same time frame, a Commodore 64 and a Tandy from Radio Shack made an appearance. Small machines, immediate feedback, no waiting. At the time, they seemed like toys—interesting, but not serious computing.
